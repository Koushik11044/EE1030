...
\textbf{Question:} If $\vec{\brak{3,3}},\vec{\brak{6,y}},\vec{\brak{x,7}}$ and $\vec{\brak{5,6}}$ are the vertices of a parallelogram taken in order, find the values of $x$ and $y$. \hfill(10,2011) \\  
