...
\solution  Direction vector of $\vec{AB}: m=\vec{B}-\vec{A}$
	   ...
	   \end{align}	   
	   length of $\vec{AB}$(Diagonal):$\abs{\abs{m}}^2$=m $m^t$
	   \begin{align}
	   \abs{\abs{\vec{AB}}}^2=\myvec{5 -3}\myvec{5\\-3}\\
	   \abs{\abs{\vec{AB}}}^2=\myvec{5^2+\brak{-3}^2}\\
           \abs{\abs{\vec{AB}}}^2=\myvec{25+9}\\
           \abs{\abs{\vec{AB}}}^2=\myvec{34}\\
           \abs{\abs{\vec{AB}}}=\sqrt{34}
	   \end{align}
