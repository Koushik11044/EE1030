...
\solution  Direction vector of $\vec{AB}: m=\vec{B}-\vec{A}$
	   ...
	   \end{align}	   
	   length of $\vec{AB}$(Diagonal):$\abs{\abs{m}}=\sqrt{{m_1}^2+{m_2}^2}$
	   \begin{align}
	   \abs{\abs{\vec{AB}}}=\sqrt{5^2+\brak{-3}^2}\\
	   \abs{\abs{\vec{AB}}}=\sqrt{25+9}=\sqrt{34}
	   \end{align}
	   so, length of diagonal=$\sqrt{34}$.

\begin{figure}[h!]
	\centering
	\includegraphics[width=0.8\linewidth]{figs/fig-1.png}
\end{figure}
